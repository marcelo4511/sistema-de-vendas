     ...
     <ul class="title">
      ...
      <div v-if="u.type_user_id == 1">
       <router-link tag="span" to="/home">
        ...
        <li><i style="color:white;" class="fa fa-chart-bar m-2"></i> BI</li>
       </router-link>
       <div class="dropdown">
        <span style="color:white;" class="drops btn btn-write dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span style="color:white;"><i class="fa fa-cog m-2"></i> Configurações</span>
        </span>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <div id="teste">
            <router-link tag="span" to="/providers">
              <li style="color:black;"><i class="fa fa-truck mr-2" aria-hidden="true"></i> Fornecedor</li>
            </router-link>
            <router-link tag="span" to="/clients">
              <li style="color:black;"><i class="fa fa-user-friends mr-2" aria-hidden="true"></i> Clientes</li>
            </router-link>
            <router-link tag="span" to="/products">
              <li style="color:black;"><i class="fa fa-shopping-bag mr-2" aria-hidden="true"></i> Produtos</li>
            </router-link>
            <router-link tag="span" to="/categories">
              <li style="color:black;"><i class="fas fa-box mr-2"></i> Categorias</li>
            </router-link> 
            <router-link tag="span" to="/users">
              <li style="color:black;"><i class="fa fa-user-friends mr-2" aria-hidden="true"></i> Usuários</li>
          </router-link>
          </div>
        </div>
      </div>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <div id="teste">
            <router-link tag="span" to="/delay">
              <li style="color:black;"><i class="fa fa-money-check-alt mr-2" aria-hidden="true"></i>Pagar Vencidas</li>
            </router-link>
            <router-link tag="span" to="/today">
              <li style="color:black;"><i class="fa fa-money-check-alt mr-2" aria-hidden="true"></i>Pagar Hoje</li>
            </router-link>
            <hr>
            <router-link tag="span" to="/billstopay">
              <li style="color:black;"><i class="fa fa-money-check-alt mr-2" aria-hidden="true"></i> Contas a pagar</li>
            </router-link>
            <router-link tag="span" to="/billstoreceive">
              <li style="color:black;"><i class="fa fa-credit-card mr-2" aria-hidden="true"></i> Contas a receber</li>
            </router-link>
            <router-link tag="span" to="/movimentacao">
              <li style="color:black;"><i class="fa fa-chart-line mr-2"></i> Fluxo de caixa</li>
            </router-link> 
          </div>
        </div>
      </div>
    ...
    <div v-if="u.type_user_id == 3">
      <div class="dropdown title">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <div id="teste">
            <router-link tag="span" to="/products">
              <li style="color:black;"><i class="fa fa-shopping-bag m-3" aria-hidden="true"></i> Produtos</li>
            </router-link>
          </div>
        </div>
      </div>
