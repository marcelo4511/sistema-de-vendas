      ...
      <form @submit.prevent="onSubmit" class="form-group">
        ...
        <div class="row">  
            ...
            <div class="form-grouṕ col-md-3">
                <label for="">CPF</label>
                <input type="text" class="form-control form-control-sm" v-model="client.cpf" @blur="verificaCpf()" required>
            </div>
        ...
        <div class="row">
            <div class="form-group col-sm-3">
                <label for="">CEP</label>
                <input type="text" class="form-control form-control-sm" v-model="client.cep" required>
            </div>
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control form-control-sm" @keyup="phoneValidator()" v-model="client.fone" required>
            </div>

            <div class="form-group col-md-4">
                <label for="">Celular</label>
                <input type="text" class="form-control form-control-sm" @keyup="phoneValidator()" v-model="client.celular" required>
            </div>
