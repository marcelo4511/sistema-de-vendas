<template>
<div>
    <h4 cabecalho="Produto">Pagar Vencidas</h4>
        <nav aria-label="breadcrumb mb-4">
            <ol class="breadcrumb ">
                <li class="breadcrumb-item"><router-link to="/home">Home</router-link></li>
                <li class="breadcrumb-item active" aria-current="page"> Pagar Vencidas</li>
            </ol>
        </nav>
   ...
   <div class="table table-responsive">
        <table class="table table-sm">
            ...
            <tbody class="text-center">
                <tr v-for="(provider,k) in pesquisar" :key="k"  v-show="provider.situacao_id == 1">
...
export default {
    ...
    methods:{
        ...
        getProvider(){
            axios.get(`${API_BASE_URL}/delay`).then(res => {
